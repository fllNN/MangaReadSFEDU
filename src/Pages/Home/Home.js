...
export const RecommendationsGrid = () => {
  return (
    <>
      <h4 style={{ color: '#eeeeee',  margin: '80px 0 25px', marginLeft: '100px', fontWeight: 'bold' }}>Ваши рекомендации</h4>
...
export const Banner = () => (
  <div style={bannerStyle}>
    <h1 style={{ color: '#ffffff', fontWeight: 'bold', margin: 0 }}>Долгожданная премьера</h1>
    <h2 style={{ color: '#ffffff', margin: '10px 0 0' }}>Название</h2>
  </div>
);
            ...
            <Card.Body>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  <span style={{ fontSize: '0.85em', color: '#eeeeee', fontWeight: 'bold' }}>8.5</span>
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="star" className="svg-inline--fa fa-star fa-w-18" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" style={{ width: '16px', height: '16px', fill: '#eeeeee' }}>
                    <path fill="currentColor" d="M259.3 17.8L194 150.2 47.9 171.5c-26.2 3.6-36.7 36.1-17.7 54.6l105.7 103-25 145.5c-4.5 26.3 23.2 46 46.4 33.7L288 439.6l130.7 68.7c23.2 12.2 50.9-7.4 46.4-33.7l-25-145.5 105.7-103c19-18.5 8.5-51-17.7-54.6l-146.1-21.3L316.7 17.8c-11.7-23.6-45.6-23.6-57.4 0z"></path>
                  </svg>
                </div>
              </div>
            </Card.Body>
